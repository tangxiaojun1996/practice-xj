...
type DeepReadonly<T> = { readonly [key in keyof T]: keyof T[key] extends undefined ? T[key] : DeepReadonly<T[key]>}
// 重点：使用 keyof T[key] extends undefined 判断子项是否是对象

// 或者使用 T[P] extends Record<string, unknown> 判断是否是对象
